...
namespace Lightbug.GrabIt
{
	...
	public class GrabIt : MonoBehaviour {
		...
		{	
			...
			m_defaultProperties.m_drag = m_targetRB.linearDamping;
			m_defaultProperties.m_angularDrag = m_targetRB.angularDamping;
			m_defaultProperties.m_constraints = m_targetRB.constraints;

			//Grab Properties	
			m_targetRB.useGravity = m_grabProperties.m_useGravity;
			m_targetRB.linearDamping = m_grabProperties.m_drag;
			m_targetRB.angularDamping = m_grabProperties.m_angularDrag;
		...
		void Grab()
		{
			...
			if(m_isHingeJoint)
				...
				m_targetRB.linearVelocity = m_grabSpeed * dif;		
		...
		void FixedUpdate()
		{
			...
			if(m_applyImpulse)
			{
				m_targetRB.linearVelocity = m_transform.forward * m_impulseMagnitude;
				Reset();
				m_grabbing = false;
